function semilogyNEG(h,varargin)
...
data        = 'YData';
scale       = 'YScale';
ticklabelmode   = 'YTickLabel';
tickmode        = 'YTick';

if nargin<1
    h = gca;
elseif nargin>1
    if strcmpi(varargin,'X')
        data        = 'XData';
        scale       = 'xscale';
        ticklabelmode   = 'XTickLabel';
        tickmode        = 'XTick';
    end
end
...
set(h,tickmode,tick,ticklabelmode,ticklabel);
end
