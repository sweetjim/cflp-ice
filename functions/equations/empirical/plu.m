function OUT = plu(varargin)
%% PLU (property look-up) of ice and water
% 
...
%       'kappaT'    - thermal diffusivity                       [m2 / s]
%       'kappaTf'   - dynamic fluid thermal diffusivity (water) [m2 / s]
%       'kappaS'    - haline diffusivity                        [m2 / s]
%       'nu'        - kinematic viscosity (water only)          [m2 / s]
% -------------------------------------------------------------------------
